 ...
 */
  ...
  if(isset($_POST["web_name"]) && !empty($_POST["web_name"]) && !is_dir("WebPages".DIRECTORY_SEPARATOR.$_POST["web_name"]))
  {
    ...
    $web_data = new WebData($_POST["web_name"], $_SESSION["weAre_user"], strtolower($_POST["web_name"]), $_POST["web_privacity"]);
          ...
          <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                ...
                <div id="general" class="accordion-collapse collapse show"> <!-- Add: data-bs-parent="#faqlist" for collaps when click on other-->
                  <div class="accordion-body" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <input type="text" class="form-control" name="web_name" <?php if(isset($json_data)) { echo 'value="' . $json_data["web_data"]["web_name"] . '"'; } ?> required>
                    <br>
                    <label for="web_privacity" class="mb-2"><b>2. Privacity</b></label>
                      ...
                      <label><b>3. Users</b></label>
                      <h5 class="form-switch">
                      <input type="checkbox" class="form-check-input" id="gallery_enable" name="gallery_enable" <?php if(isset($json_data) && $json_data["users"]["enable"]) { echo 'checked'; } ?>>
                      </h5>
                      <br>
                  </div>
                </div>
            ...
            <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                ...
                <div id="gallery" class="accordion-collapse <?php if(isset($json_data) && !$json_data["gallery"]["enable"]) { echo 'collapse'; } ?>"> <!-- Add: data-bs-parent="#faqlist" for collaps when click on other-->
                  <div class="accordion-body" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                ...
                <div id="blog" class="accordion-collapse <?php if(isset($json_data) && !$json_data["blog"]["enable"]) { echo 'collapse'; } ?>"> <!-- Add: data-bs-parent="#faqlist" for collaps when click on other-->
                  <div class="accordion-body" data-aos="fade-up" data-aos-delay="200">
                    <div class="row">
                      <div class="col-lg-12">
                        <div id="inputFormRow">
