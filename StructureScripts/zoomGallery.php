  ...
  <div class="container-fluid" data-aos="fade-up" data-aos-delay="200">
    ...
    foreach ($dir as $value) {
      if($value!="." && $value!=".." && $value!="No-category")
      {
        ...
        {
          $zoom_gallery_code.= '<li data-filter=".filter-' . str_replace(" ", "", $value) . '">' . ucfirst($value) . '</li>';
        }
      }
    }
    ...
    if($tag!="." && $tag!="..")
    {
      if(is_dir("images/gallery" . DIRECTORY_SEPARATOR . $folder . DIRECTORY_SEPARATOR . $tag))
      {
        ...
        foreach ($album as $image) {
          ...
          {
            $zoom_gallery_code.= '
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-' . str_replace(" ", "", $tag) .'" style="padding-left: 2px; padding-right: 0px; padding-bottom: 2px;">
