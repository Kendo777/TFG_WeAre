...
if(isset($_GET["edit"]))
{
	...
	if($value!="." && $value!="..")
	{
		...
		if(is_dir($path.DIRECTORY_SEPARATOR.$file))
		{
          ...
          echo '<td><form action="index.php?page=gallery&folder='.$folder.'&edit" method="post">
	...
	if($value!="." && $value!=".." && $value!="comentario.txt")
	{
		...
		if(!is_dir($path.DIRECTORY_SEPARATOR.$file))
		{
			...
			if(strpos($value,'mp4'))
			{
				echo '<td><div class="col-lg-3 col-md-4 col-xs-6 thumb">
	...
	foreach ($dir as $value) {
		if($value!="." && $value!="..")
		{
			...
			if(is_dir($path.DIRECTORY_SEPARATOR.$file))
			{
				...
				echo '<section class="content-section bg-light folder-img" style="background: url(\''.$imgUrl.'\'); margin-bottom: 20px;" >
